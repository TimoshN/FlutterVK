...
function(add_library TARGET)
    ...
    if (
      "${TARGET}" MATCHES "^connectivity_plus_aurora_platform_plugin$" OR
      "${TARGET}" MATCHES "^isar_flutter_libs_platform_plugin$" OR
      "${TARGET}" MATCHES "^media_kit_video_aurora_platform_plugin$" OR
      "${TARGET}" MATCHES "^package_info_plus_aurora_platform_plugin$" OR
      "${TARGET}" MATCHES "^path_provider_aurora_platform_plugin$" OR
      "${TARGET}" MATCHES "^url_launcher_aurora_platform_plugin$" OR
      FALSE
    )
