...
%global __requires_exclude ^lib(dconf|jpeg|lzma|opus|speex|xkbcommon|flutter-embedder|maliit-glib|mpv|pulse|harfbuzz|freetype|fribidi|drm|.+_platform_plugin)\\.so.*$
