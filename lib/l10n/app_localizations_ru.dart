...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get general_settings => 'Настройки';
  ...
  @override
  String get visual_settings => 'Стиль и внешний вид';

  @override
  String get visual_settings_desc => 'Изменение внешнего вида и стиля приложения';
  ...
  @override
  String get player_dynamic_color_scheme_type => 'Палитра цветовой темы';
  ...
  @override
  String get fullscreen_player => 'Полнооконный плеер';

  @override
  String get fullscreen_player_desc => 'Изменение внешнего вида полнооконного плеера';

  @override
  String get use_track_thumb_as_player_background => 'Обложка трека как фон';

  @override
  String get playback => 'Воспроизведение';

  @override
  String get playback_desc => 'Управение поведением, настройками воспроизведения';
  ...
  @override
  String get android_keep_playing_on_close_desc => 'Определяет, продолжится ли воспроизведение после \"закрытия\" приложения в списке \"недавних\"';
  ...
  @override
  String get integrations_desc => 'Работа со сторонними сервисами';

  @override
  String get status_broadcast => 'Трансляция в статус';

  @override
  String get status_broadcast_desc => 'Отображает трек в статусе ВКонтакте';
  ...
  @override
  String get deezer_thumbnails_desc => 'Загружает недостающие обложки из Deezer';

  @override
  String get lrclib_lyrics => 'Тексты песен через LRCLIB';

  @override
  String get lrclib_lyrics_desc => 'Берёт тексты песен из LRCLIB если они недоступны во ВКонтакте, либо они не являются синхронизированными';

  @override
  String get apple_music_animated_covers => 'Анимированные обложки Apple Music';

  @override
  String get apple_music_animated_covers_desc => 'Загружает анимированные обложки из Apple Music, которые отображаются в полнооконном плеере';

  @override
  String get experimental_options => 'Экспериментальные функции';

  @override
  String get experimental_options_desc => 'Раздел, в котором могут обитать страшные драконы';

  @override
  String get experimental_no_options_available => 'В данной версии приложения нет доступных экспериментальных функций.';
  ...
  @override
  String get updates_desc => 'Параметры системы обновлений';
  ...
  @override
  String get force_update_check => 'Проверить на наличие обновлений';
  ...
  @override
  String get data_control => 'Экспорт, импорт и удаление данных';

  @override
  String get data_control_desc => 'Позволяет управлять данными, хранящимися в приложении';

  @override
  String get export_settings => 'Экспорт настроек';

  @override
  String get export_settings_desc => 'Сохраняет изменения настроек приложения и треков в файл, чтобы восстановить их на другом устройстве';
  ...
  @override
  String get debug_options => 'Отладочные опции';

  @override
  String get debug_options_desc => 'Опции, необходимые для изучения и исправления технических проблем';
  ...
  @override
  String get player_debug_logging_desc => 'Включает вывод технических данных плеера, ухудшая при этом производительность';
  ...
  @override
  String get development_options => 'Опции разработки';

  @override
  String get development_options_desc => 'Эти опции предназначены лишь для разработчиков';
